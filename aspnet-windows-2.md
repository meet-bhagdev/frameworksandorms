...
framework: aspnet
title: windows
permalink: /aspnet/windows/step/2
---

> After getting SQL Server and ASP.NET on your Windows machine, you can now proceed to create your new ASP.NET projects. Here we will explore creating a web application that connects to SQL Server using Entity Framework. 

Create a ASP.NET MVC Web Application 
1. Launch Visual Studio Community 
1. Click **File -> New -> Project**
1. In the **New project** dialog, click **Web** located under **Visual C#** in the **Templates** node
1. Click **ASP.NET Web Application (.NET Framework)***
1. Name the project _"aspnetsample"_ 
1. Click **OK**
1. Click the **MVC** template
1. Click **OK**

Visual Studio will create a new ASP.NET Web Application project. 
